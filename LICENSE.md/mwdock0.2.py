...
#from MindWay import *  #没有转换py文件，此行取消
...
#		self.ui.listView.setFixedSize(600,460)
		self.ui.toolButton.setToolTip("下一页")

		self.ui.toolButton_10.setToolTip("文式")

		self.ui.toolButton_11.setToolTip("计算")

		self.ui.toolButton.setFixedSize(40,20)
		self.ui.toolButton_9.setFixedSize(40,20)
		self.ui.toolButton_10.setFixedSize(40,20)
		self.ui.toolButton_11.setFixedSize(40,20)

		self.ui.toolButton_2.setFixedSize(200,20)
		self.ui.toolButton_3.setFixedSize(200,20)
		self.ui.toolButton_4.setFixedSize(200,20)

		self.ui.toolButton_5.setFixedSize(20,100)
		self.ui.toolButton_5.setToolTip("上一页")

#        self.horizontalLayout_5.setFixedSize(450,21)
		self.ui.toolButton_6.setFixedSize(200,20)
		self.ui.toolButton_6.setToolTip("定位文件")
		self.ui.toolButton_7.setFixedSize(200,20)
		self.ui.toolButton_8.setFixedSize(200,20)
		self.ui.toolButton_8.setToolTip("打开文件")

		self.model = QStandardItemModel()
		self.ui.listView.clicked.connect(self.ViewOp)

#		self.ui.pushButton.clicked.connect(self.slot_btn_chooseFile)
		self.ui.toolButton_6.clicked.connect(self.slot_btn_chooseFile)#选择文件

		self.ui.toolButton_7.clicked.connect(self.AddItem)#增加项

#		self.ui.pushButton_2.clicked.connect(self.slot_btn_openFile)
		self.ui.toolButton_8.clicked.connect(self.slot_btn_openFile)#打开文件

		self.ui.toolButton_9.clicked.connect(self.SearchRow)#搜索内容

#		self.ui.pushButton_3.clicked.connect(self.CopyText)#引用文式
		self.ui.toolButton_10.clicked.connect(self.CopyText)#V

#		self.ui.pushButton_4.clicked.connect(self.handle)
		self.ui.toolButton_11.clicked.connect(self.handle)#计算

		self.ui.toolButton_1.clicked.connect(self.Extract)#摘录显示

		self.ui.toolButton.clicked.connect(QCoreApplication.instance().quit)#退出
#		self.ui.pushButton_5.clicked.connect(QCoreApplication.instance().quit)
		self.ui.show()

###setCurrentIndex(
	def SearchRow(self):
		ss=self.model.item(0).index().data()
...
#		for i in range(self.model.rowCount()):
			...
			if(newpos>=0):#发现0项内容
				...
				self.ui.listView.setCurrentIndex(si)
				itemc=self.model.item(i)
				itemc.setData(QVariant(Qt.Checked),Qt.CheckStateRole)
				break
			i+=1
		if(i==it):
			self.PosFound=0
...
#		fh = ''
		fh=open(self.fileName_choose,'r')
#			with fh:
		data=fh.read()
